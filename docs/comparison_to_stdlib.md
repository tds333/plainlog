...
| **Processors** | A pipeline of callables (**processors**) run in the Core thread after dequeueing, wrapped around the handler by `ProcessingHandler`. This is a first-class concept. | No direct equivalent. Filters exist but are less composable. |
